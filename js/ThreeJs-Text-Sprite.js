 ...
 **/
 ...
 export const generateTextSprite = function( text, config ) {
    ...
    var borderColor = config.hasOwnProperty('borderColor') ? config['borderColor'] : 'rgba(0, 0, 0, 0)';
    var borderRadius = config.hasOwnProperty('borderRadius') ? config['borderRadius'] : 0;
    var backgroundColor = config.hasOwnProperty('backgroundColor') ? config['backgroundColor'] : 'rgba(0, 0, 255, 0)';
